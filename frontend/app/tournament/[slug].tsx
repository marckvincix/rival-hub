...
const styles = StyleSheet.create({
  ...
  matchTeam: { flex: 1, flexDirection: 'row', alignItems: 'center' },
  matchTeamName: { fontSize: 13, fontWeight: '600', color: '#000', marginHorizontal: 8, flex: 1 },
  matchResult: { paddingHorizontal: 12 },
