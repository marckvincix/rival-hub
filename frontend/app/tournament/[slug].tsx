...
const styles = StyleSheet.create({
  ...
  matchCenter: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 12 },
  matchTeamNameHome: { fontSize: 13, fontWeight: '600', color: '#000', textAlign: 'right', flex: 1 },
  matchTeamNameAway: { fontSize: 13, fontWeight: '600', color: '#000', textAlign: 'left', flex: 1 },
  matchResult: { paddingHorizontal: 12, minWidth: 60, alignItems: 'center' },
