...
const styles = StyleSheet.create({
  ...
  matchCard: { borderWidth: 2, borderColor: '#000', borderRadius: 16, paddingVertical: 16, paddingHorizontal: 12, marginBottom: 8 },
  matchRow: { flexDirection: 'row', alignItems: 'center' },
  matchCenterContent: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 8 },
  matchTeamName: { fontSize: 14, fontWeight: '500', color: '#000' },
  matchScore: { fontSize: 15, fontWeight: '500', color: '#000', marginHorizontal: 8 },
