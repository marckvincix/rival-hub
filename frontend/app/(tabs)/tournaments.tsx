...
const styles = StyleSheet.create({
  ...
  matchPillMain: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', flex: 1 },
  matchStatsBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 6, backgroundColor: '#F0F0F0', borderRadius: 8, marginTop: 8 },
  matchStatsBtnText: { fontSize: 12, color: '#666' },
