...
const styles = StyleSheet.create({
  ...
  matchCard: { borderWidth: 2, borderColor: '#000', padding: 14, borderRadius: 12, marginBottom: 8 },
  matchRound: { fontSize: 12, color: '#666', marginBottom: 8, fontWeight: '600' },
  matchTeams: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  matchTeamName: { fontSize: 14, fontWeight: '600', color: '#000', flex: 1 },
  matchScore: { paddingHorizontal: 16 },
  scoreText: { fontSize: 18, fontWeight: '700', color: '#000' },
  vsText: { fontSize: 14, color: '#999' },
  deleteMatchBtn: { position: 'absolute', top: 8, right: 8 },
